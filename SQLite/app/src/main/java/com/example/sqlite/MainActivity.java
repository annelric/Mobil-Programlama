...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yas = findViewById(R.id.TextYas);
        sehir = findViewById(R.id.TextSehir);
    ...
    private void KayitEkle(String adi, String soyadi, String yasi, String sehri) {
        try {
            ...
            db.close();
            Log.d(TAG, "Kayit basariyla eklendi");
        } catch(Exception e) {
            Log.e(TAG, "Kayit eklenirken hata olustu" +e.getMessage());
        }
    }
    ...
    private void KayitSil(String adi) {
        try {
            ...
            db.close();
            Log.d(TAG, "kayit silindi");
        } catch (Exception e) {
            Log.e(TAG, "Kayit silinirken hata olustu" +e.getMessage());
        }
    }
    ...
    private void KayitGuncelle(String adi, String soyadi, String yasi, String sehri) {
        try {
            ...
            db.close();
            Log.d(TAG, rows+ "Kayit güncellendi");
        } catch (Exception e) {
            Log.e(TAG, "Kayit güncellenirken hata olustu" +e.getMessage());
        }
    }
}